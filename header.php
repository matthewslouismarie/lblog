	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( is_front_page() && is_home() ) :
				...
				?>
				<p class="site-title"><a class="link" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></p>
				<?php
			endif;
		...
		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'lblog' ); ?></button>
			<?php
			wp_nav_menu( array(
